...
import org.usfirst.frc2175.Robot2014.lib.CheesyVisionServer;
...
public class Robot extends IterativeRobot {
    ...
    CheesyVisionServer _cheesyVisionServer = CheesyVisionServer.getInstance();
    public final int _cheesyVisionPort = 1180;
    ...
    public void robotInit() {
        _cheesyVisionServer.setPort(_cheesyVisionPort);
        _cheesyVisionServer.start();
...
//	autoChooser.addObject("5 - High Goal, Hot Goal, Mobility Bonus", /* tbd */);
    ...
    public void disabledInit() {
        _cheesyVisionServer.stopSamplingCounts();
    }

    public void autonomousInit() {
        _cheesyVisionServer.reset();
        _cheesyVisionServer.startSamplingCounts();
...
//        autonomousCommand = new Auton3DoubleBlindShot();
	...
	if (oi.getGamepad().getRawButton(6))
        ...
        System.out.println("Current left: " + _cheesyVisionServer.getLeftStatus() + ", current right: " + _cheesyVisionServer.getRightStatus());
        System.out.println("Left count: " + _cheesyVisionServer.getLeftCount() + ", right count: " + _cheesyVisionServer.getRightCount() + ", total: " + _cheesyVisionServer.getTotalCount() + "\n");
    }
	...
	SmartDashboard.putBoolean("Arm Out Switch 2", Robot.arm.IsArmSwitch2());
        ...
        SmartDashboard.putBoolean("CheesyVision Left",_cheesyVisionServer.getLeftStatus());
        SmartDashboard.putBoolean("CheesyVision Right",_cheesyVisionServer.getRightStatus());
        SmartDashboard.putBoolean("CheesyVision Bottom",_cheesyVisionServer.getBottomStatus());
    }
