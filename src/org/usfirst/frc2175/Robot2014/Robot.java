...
public class Robot extends IterativeRobot {
	...
	autoChooser.addObject("-1 - Test", new AutonMinus1Test());
        autoChooser.addObject("-2 - Null (for CheatyVision in Auto)", null);
    ...
    public void autonomousPeriodic() {
        // update CheatyVision inputs
        oi.cv_base.update();
        
        // run the Scheduler on any auto command or any command spawned by CheatyVision
    ...
    public void teleopPeriodic() {
        ...
        // run the Scheduler on any and all commands spawned by control unputs
        Scheduler.getInstance().run();
