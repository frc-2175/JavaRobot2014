...
public class RobotMap {
    ...
    public static void init() {
        drivetrainLeft = new Victor(1, 1);
	LiveWindow.addActuator("Drivetrain", "Left", (Victor) drivetrainLeft);
        
        drivetrainRight = new Victor(1, 2);
	LiveWindow.addActuator("Drivetrain", "Right", (Victor) drivetrainRight);
	...
	LiveWindow.addSensor("Drivetrain", "Gyro", drivetrainGyro);
        ...
        armRollerBar = new Jaguar(1, 4);
	LiveWindow.addActuator("Arm", "Roller Bar", (Jaguar) armRollerBar);
	...
	LiveWindow.addSensor("Launcher", "Winch Up Switch", launcherWinchUpSwitch);
        ...
        launcherWinchMotor = new Jaguar(1, 3);
	LiveWindow.addActuator("Launcher", "Winch Motor", (Jaguar) launcherWinchMotor);
