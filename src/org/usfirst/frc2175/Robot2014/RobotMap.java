...
public class RobotMap {
    ...
    public static AnalogChannel launcherBallSensor;
    ...
    public static PIDController drivetrainEncoderPID;
    public static PIDController drivetrainGyroPID;
	...
	LiveWindow.addActuator("Launcher", "Winch Motor", (Talon) launcherWinchMotor);
        ...
        launcherWinchEncoder = new Encoder(1, 13, 1, 14, false, EncodingType.k4X);
	...
	LiveWindow.addActuator("Drivetrain", "Encoder PID", drivetrainEncoderPID);
	...
	// The output of this controller is irrelevant, since we will get the value manually and use it ourselves.
	LiveWindow.addActuator("Drivetrain", "Gyro PID", drivetrainGyroPID);
