package org.usfirst.frc2175.Robot2014.lib;
...
public class CheesyVisionServer implements Runnable {
  ...
  private boolean curLeftStatus_ = false, curRightStatus_ = false, curBottomStatus_ = false;
  ...
  public void reset() {
    ...
    curLeftStatus_ = curRightStatus_ = curBottomStatus_ = false;
  }
