...
public class Drivetrain extends Subsystem {
    ...
    public Drivetrain() {
        encoderPIDOut = new PIDOut(0.0);
        encoderPID = new PIDController(1.0, 0.1, 0.0,/* F: 0.0, */ leftEncoder, encoderPIDOut, 0.02);
        ...
        gyroPIDOut = new PIDOut(0.0);
        gyroPID = new PIDController(0.05, 0.0001, 0.0,/* F: 0.0, */ gyro, gyroPIDOut, 0.02);
        // The output of this controller is irrelevant, since we will get the value manually and use it ourselves.
